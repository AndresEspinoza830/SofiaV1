      ...
      <div className="w-full py-1 shadow-lg z-98">
        <div className="flex justify-between items-center w-full px-10 2xl:px-20">
          ...
          <div className="flex relative h-full">
            ...
            {/* </Link> */}
            <button className="border-2 font-abc font-philo text-lg border-black bg-transparent hover:border-[#D9BF73] hover:text-[#D9BF73] rounded-sm py-2 px-6 duration-300">
              Go to Menu
            </button>
          </div>
        </div>
